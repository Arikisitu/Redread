...
class AppSettings @Inject constructor(@ApplicationContext context: Context) {
	...
	var sourceAccessPasswordHash: String?
		...
		set(value) = prefs.edit {
			if (value != null) putString(KEY_SOURCE_ACCESS_PASSWORD_HASH, value) else remove(KEY_SOURCE_ACCESS_PASSWORD_HASH)
		}

	var sourceAccessPasswordSalt: String?
		get() = prefs.getString(KEY_SOURCE_ACCESS_PASSWORD_SALT, null)
		set(value) = prefs.edit {
			if (value != null) putString(KEY_SOURCE_ACCESS_PASSWORD_SALT, value) else remove(KEY_SOURCE_ACCESS_PASSWORD_SALT)
		}
	...
	companion object {
		...
		const val KEY_SOURCE_ACCESS_PASSWORD_HASH = "source_access_password_hash"
		const val KEY_SOURCE_ACCESS_PASSWORD_SALT = "source_access_password_salt"
